...
Prof [Felix Schönbrodt](https://www.osc.uni-muenchen.de/about_us/director/index.html), LMU Open Science Center managing director and Professor of Psychology at the LMU, will set the scene and present an overview of the replicability crisis across fields, and an introduction to open research initiatives.
...
In his presentation, Prof. [Uli Dirnagl](https://expneuro.charite.de/en/metas/person_detail/person/address_detail/prof_dr_ulrich_dirnagl-1/), Head of Department of Experimental Neurology at the Charité in Berlin, Co-founder and Director of the Center for Stroke Research Berlin, and Founding Director of QUEST, The Center for Transforming Biomedical Research at the Berlin Institute of Health, will present a set of behaviours, activities and research practices which present prime targets for improvement.

## Stephan Hartmann: Bayesian Philosophy of Science

![](img/stephan-hartmann.png){width="100"} Tuesday 12 September, 10:00-10:45

Prof [Stephan Hartmann](http://www.stephanhartmann.org/), Professor of Philosophy at the LMU, and Co-Director of the Munich Center for Mathematical Philosophy (MCMP), will present his thoughts on scientific reasoning, and argue that good arguments and good inferences are characterized by their effect on our rational degrees of belief. Refuting the view that there is no place for subjective attitudes in 'objective science', he will explain the value of convincing evidence in terms of a cycle of variations on the theme of representing rational degrees of belief by means of subjective probabilities (and changing them by Bayesian conditionalization). We will then discuss reforms of research methodology, which the open research movement proposes, in the context of such scientific reasoning.

## Tony Ross-Hellauer: Open = Inclusive and Equitable?

![](img/tony-ross-hellauer.png){width="100"} Tuesday 12 September, 11:00-11:45

[Tony Ross-Hellauer](https://tonyr-h.github.io/) Leader of the Open and Reproducible Research Group, Graz University of Technology and Know-Center, Austria, will discuss why equity should be included as an explicit consideration in the policies, reforms, and support mechanisms driving the transition to Open Science.
...
[Valérie Labonté](https://www.cochrane.de/ueber-uns/team), researcher at Cochrane Germany, will present how to preserve integrity of results through following reporting guidelines. 
...
Prof [Denis Kenji Kipker](https://denniskenjikipker.de/), Professor for IT Security Law, World Trade Center, Bremmen, will present what licences are appropriate for sharing data and code. 
