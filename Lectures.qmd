...
Prof [Felix Schönbrodt](https://www.osc.uni-muenchen.de/about_us/director/index.html), LMU Open Science Center managing director and Prof of Psychology at the LMU, will set the scene and present an overview of the replicability crisis across fields, and an introduction to open research initiatives.
...
[Tony Ross-Hellauer](https://tonyr-h.github.io/) Leader Open and Reproducible Research Group, Graz University of Technology and Know-Center, Austria, will discuss why equity should be included as an explicit consideration in the policies, reforms, and support mechanisms driving the transition to Open Science.
...
Prof [Felix Schönbrodt](https://www.osc.uni-muenchen.de/about_us/director/index.html), LMU Open Science Center managing director and Prof of Psychology at the LMU, will present new technological solutions that allow sharing sensible data (e.g. synthetical data, scientific use files, differential privacy).
...
[Valérie Labonté](https://www.cochrane.de/ueber-uns/team), researcher at Cochrame Deutschland, will present how to preserve integrity of results through following reporting guidelines. 
...
Dr [Raphael Ritz](https://www.rd-alliance.org/users/raphael), Head of Data Division at Max Planck Computing and Data Facility, will present FAIR data and software.

## Dennis Kenji Kipker: Research Copyrights

![](img/dennis-kenji-kipker.png){width="100"} Friday 15 September, 11:00-11:45

Prof [Denis Kenji Kipker](https://denniskenjikipker.de/), Professor for IT Security Law, World Trade Center, Bremmen, will present appropriate licences for sharing data and code. 
